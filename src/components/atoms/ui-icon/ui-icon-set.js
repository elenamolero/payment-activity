  ...
  render() {
    return html`
      ...
      >
        ...
        <symbol id="car" viewBox="0 0 640 640">
          <path
        ...
        <symbol id="caret-down" viewBox="0 0 640 640">
          <path
        ...
        <symbol id="caret-up" viewBox="0 0 640 640">
          <path
...
customElements.define('ui-icon-set', UiIconSet);
